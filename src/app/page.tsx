        ...
        <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 overflow-hidden pt-20 sm:pt-16">
          ...
          <div className="relative z-10 max-w-7xl mx-auto text-center animate-fade-in">
            <div className="mb-8 inline-block">
              <span className="px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary text-xs font-semibold tracking-wide uppercase">Beta now live</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-8 sm:mb-12 px-4">
              <Link className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-gradient-hero text-primary-foreground font-semibold rounded-lg hover:opacity-90 transition-all duration-300 shadow-lg hover:shadow-glow text-base sm:text-lg text-center" href="/markets">
                View Markets
              </Link>
              <Link className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 border-2 border-primary/30 text-primary font-semibold rounded-lg hover:bg-primary/10 hover:border-primary/50 transition-all duration-300 text-base sm:text-lg flex items-center justify-center gap-2" href="/docs">
            ...
            <div className="mb-8 sm:mb-12">
              <p className="text-sm text-accent uppercase tracking-wider mb-4 flex items-center justify-center gap-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 max-w-4xl mx-auto px-4">
                ...
                <div className="bg-card border border-border rounded-xl p-6 hover:border-primary/30 transition-all duration-300 group">
                  ...
                  <div className="text-3xl font-bold mb-1 group-hover:text-primary transition-colors text-card-foreground">6</div>
                  <div className="text-sm text-muted-foreground uppercase tracking-wide">Active Markets</div>
                </div>
                ...
                <div className="bg-card border border-border rounded-xl p-6 hover:border-primary/30 transition-all duration-300 group">
                  ...
                  <div className="text-3xl font-bold mb-1 group-hover:text-primary transition-colors text-card-foreground">16</div>
                  <div className="text-sm text-muted-foreground uppercase tracking-wide">Online Traders</div>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-gradient-card border border-border rounded-xl p-6 hover:border-primary/30 transition-all duration-300 group animate-fade-in">
                <div className="mb-4 text-primary group-hover:scale-110 transition-transform duration-300">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6">
                    <path d="M4 14a1 1 0 0 1-.78-1.63l9.9-10.2a.5.5 0 0 1 .86.46l-1.92 6.02A1 1 0 0 0 13 10h7a1 1 0 0 1 .78 1.63l-9.9 10.2a.5.5 0 0 1-.86-.46l1.92-6.02A1 1 0 0 0 11 14z" />
                  </svg>
                </div>
                <h3 className="text-lg font-bold mb-2 group-hover:text-primary transition-colors text-card-foreground">Instant Settlements</h3>
                <p className="text-sm text-muted-foreground leading-relaxed">Automated payouts when markets resolve</p>
              </div>
              ...
              <div className="bg-gradient-card border border-border rounded-xl p-6 hover:border-primary/30 transition-all duration-300 group animate-fade-in">
                ...
                <h3 className="text-lg font-bold mb-2 group-hover:text-primary transition-colors text-card-foreground">Create Your Markets</h3>
                <p className="text-sm text-muted-foreground leading-relaxed">Launch prediction markets on any topic</p>
              </div>
              ...
              <div className="bg-gradient-card border border-border rounded-xl p-6 hover:border-primary/30 transition-all duration-300 group animate-fade-in">
                ...
                <h3 className="text-lg font-bold mb-2 group-hover:text-primary transition-colors text-card-foreground">Community Driven</h3>
                <p className="text-sm text-muted-foreground leading-relaxed">Built by traders, for traders</p>
              </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-center gap-6">
            ...
            <div className="flex gap-6 text-sm text-muted-foreground">
              ...
              <Link href="/contract" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">Contract</Link>
